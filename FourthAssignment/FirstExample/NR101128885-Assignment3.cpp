...
// Camera matrix
	...
	*/
	...
	float normalMapCube[] = {
		0.0f, 0.0f, 1.0f, // 00            // Front_1    
		0.0f, 0.0f, 1.0f, // 01				// Front_2
		0.0f, 0.0f, 1.0f, // 02		// Front_3
		0.0f, 0.0f, 1.0f, // 03		// Front_4
		0.0f, 0.0f, -1.0f, // 04 			// Back_1 
		0.0f, 0.0f, -1.0f, // 05				// Back_2
		0.0f, 0.0f, -1.0f, // 06		// Back_3
		0.0f, 0.0f, -1.0f, // 07		// Back_4

		0.0f, -1.0f, 0.0f, // 08 		// Bottom_1 
		0.0f, -1.0f, 0.0f, // 09		// Botton_4
		0.0f, 1.0f, 0.0f, // 10		// Top_2
		0.0f, 1.0f, 0.0f, // 11		// Top_1
		0.0f, -1.0f, 0.0f, // 12		// Bottom_2
		0.0f, -1.0f, 0.0f, // 13		// Bottom_3
		0.0f, 1.0f, 0.0f, // 14		// Top_3
		0.0f, 1.0f, 0.0f, // 15		// top_4

		-1.0f, 0.0f, 0.0f, // 16		// Left_4
		1.0f, 0.0f, 0.0f, // 17		// Right_1
		1.0f, 0.0f, 0.0f, // 18		// Right_4
		-1.0f, 0.0f, 0.0f, // 19		// Left_1
		-1.0f, 0.0f, 0.0f, // 20		// Left_3
		1.0f, 0.0f, 0.0f, // 21		// Right_2
		1.0f, 0.0f, 0.0f,// 22		// Right_3
		-1.0f, 0.0f, 0.0f // 23		// Left_2
	};
	...
	glBufferData(GL_ARRAY_BUFFER, sizeof(normalMapCube), normalMapCube, GL_STATIC_DRAW);
